...
<body>
    <nav>
        ...
        <ul>
            ...
            <?php if (isset($_SESSION['level']) == 'admin') : ?>
                <li><a href="tampil_customer.php">customer dashboard</a></li>
            <?php endif; ?>
    ...
    <div class="container">
        <h1>Selamat Datang, Customer <?php echo $_SESSION['username']; ?></h1>
        <ul>
            <li><a href="tampil_customer.php" class="btn btn-primary">Tampilkan Data</a></li>
